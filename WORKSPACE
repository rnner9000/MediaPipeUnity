...
http_archive(
    ...
    patches = [
        ...
        "@//third_party:mediapipe_anchor_rename_transformations.diff",
        "@//third_party:mediapipe_anchor_rename_tracked_anchor.diff",
        "@//third_party:mediapipe_anchor_rename_sticker_manager.diff",
    ],
